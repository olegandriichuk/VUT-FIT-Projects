...
void List_Dispose( List *list ) {
	ListElementPtr Current_Element = list->firstElement;
	/* uvolnovani vsech elememtu*/
	while(Current_Element  != NULL){
		ListElementPtr Next_Element = Current_Element->nextElement;
...
void List_DeleteFirst( List *list ) {
	...
	ListElementPtr First_Element_to_Delete = list->firstElement;
	list->firstElement = list->firstElement->nextElement;
	free(First_Element_to_Delete);
...
void List_DeleteAfter( List *list ) {
	if(list->activeElement == NULL || list->activeElement->nextElement == NULL)
		return;
	/*ruseni elementu a uvolnovani pameti*/	
	ListElementPtr Element_to_Delete = list->activeElement->nextElement;
